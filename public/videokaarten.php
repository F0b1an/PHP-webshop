<?php
	...
	$database = db();
// haalt producten uit database met categorie videokaarten
	$products = $database->prepare('SELECT * FROM products WHERE category = "videokaarten" ORDER BY id DESC');
	try {
		$products->execute([]);
				...
				<div id="contentcontainer">
					...
					<div class="product">
						<div class="productphoto">
							<img src="images/<?php echo $product['image']; ?>" alt="videokaart" class="foto" />
						</div>
