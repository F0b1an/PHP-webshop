<?php
	...
	$database = db();
	// haalt producten uit database met categorie case
	$products = $database->prepare('SELECT * FROM products WHERE category = "case" ORDER BY id DESC');
	try {
		$products->execute([]);
				...
				<div id="contentcontainer">
					...
					<div class="product">
						<div class="productphoto">
							<img src="images/<?php echo $product['image']; ?>" alt="case" class="fotomobo" />
						</div>
